...
protected:
	...
	{
		qDebug() << "INFO: CBerBMPString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::BMP_STRING_TAG);
	}
	...
	CBerBMPString(const CBerBMPString& rhs): QObject()
	{
	...
	CBerBMPString& operator=(const CBerBMPString& rhs)
	{
	...
	bool operator!=(const CBerBMPString& rhs)
	{
...
Q_DECLARE_METATYPE(CBerBMPString*)
