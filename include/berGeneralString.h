...
class ASN1_SHAREDEXPORT CBerGeneralString: public QObject, public IBerBaseType
{
	Q_OBJECT
...
protected:
	...
	{
		qDebug() << "INFO: CBerGeneralString has member already.";
		return nullptr;
	}
...
public:
	...
	CBerGeneralString(const CBerGeneralString& rhs): QObject()
	{
	...
	virtual ~CBerGeneralString() {}

	CBerGeneralString& operator=(const CBerGeneralString& rhs)
	{
	...
	bool operator!=(const CBerGeneralString& rhs)
	{
...
Q_DECLARE_METATYPE(CBerGeneralString*)
