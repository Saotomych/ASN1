...
protected:
	...
	{
		qDebug() << "INFO: CBerGeneralizedTime has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::GENERALIZED_TIME_TAG);
	}
	...
	CBerGeneralizedTime(const CBerGeneralizedTime& rhs): QObject()
	{
	...
	CBerGeneralizedTime& operator=(const CBerGeneralizedTime& rhs)
	{
	...
	bool operator!=(const CBerGeneralizedTime& rhs)
	{
