...
class ASN1_SHAREDEXPORT CBerIA5String: public QObject, public IBerBaseType
{
	Q_OBJECT
...
protected:
	...
	{
		qDebug() << "INFO: CBerA5String has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::IA5_STRING_TAG);
	}
	...
	CBerIA5String(const CBerIA5String& rhs): QObject()
	{
	...
	CBerIA5String& operator=(const CBerIA5String& rhs)
	{
	...
	bool operator!=(const CBerIA5String& rhs)
	{
