...
class ASN1_SHAREDEXPORT CBerNumericString: public QObject, public IBerBaseType
{
	Q_OBJECT
...
protected:
	...
	{
		qDebug() << "INFO: CBerNumericString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::NUMERIC_STRING_TAG);
	}
	...
	CBerNumericString(const CBerNumericString& rhs): QObject()
	{
	...
	CBerNumericString& operator=(const CBerNumericString& rhs)
	{
	...
	bool operator!=(const CBerNumericString& rhs)
	{
...
Q_DECLARE_METATYPE(CBerNumericString*)
