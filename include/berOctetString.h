...
protected:
	...
	{
		qDebug() << "INFO: CBerOctetString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::OCTET_STRING_TAG);
	}
	...
	CBerOctetString(const CBerOctetString& rhs): QObject()
	{
	...
	CBerOctetString& operator=(const CBerOctetString& rhs)
	{
	...
	bool operator!=(const CBerOctetString& rhs)
	{
