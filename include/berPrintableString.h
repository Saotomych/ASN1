...
protected:
	...
	{
		qDebug() << "INFO: CBerPrintableString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::PRINTABLE_STRING_TAG);
	}
	...
	CBerPrintableString(const CBerPrintableString& rhs): QObject()
	{
	...
	CBerPrintableString& operator=(const CBerPrintableString& rhs)
	{
	...
	bool operator!=(const CBerPrintableString& rhs)
	{
...
Q_DECLARE_METATYPE(CBerPrintableString*)
