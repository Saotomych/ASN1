...
class ASN1_SHAREDEXPORT CBerTeletexString: public QObject, public IBerBaseType
{
	Q_OBJECT
...
protected:
	...
	{
		qDebug() << "INFO: CBerTeletexString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::TELETEX_STRING_TAG);
	}
	...
	CBerTeletexString(const CBerTeletexString& rhs): QObject()
	{
	...
	CBerTeletexString& operator=(const CBerTeletexString& rhs)
	{
	...
	bool operator!=(const CBerTeletexString& rhs)
	{
...
Q_DECLARE_METATYPE(CBerTeletexString*)
