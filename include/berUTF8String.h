...
class ASN1_SHAREDEXPORT CBerUTF8String: public QObject, public IBerBaseType
{
	Q_OBJECT
...
protected:
	...
	{
		qDebug() << "INFO: CBerUTF8String has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::UTF8_STRING_TAG);
	}
	...
	CBerUTF8String(const CBerUTF8String& rhs): QObject()
	{
	...
	CBerUTF8String& operator=(const CBerUTF8String& rhs)
	{
	...
	bool operator!=(const CBerUTF8String& rhs)
	{
