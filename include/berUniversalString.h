...
protected:
	...
	{
		qDebug() << "INFO: CBerUniversalString has member already.";
		return nullptr;
	}
...
public:
	...
	{
		return CBerIdentifier(CBerIdentifier::UNIVERSAL_CLASS, CBerIdentifier::PRIMITIVE, CBerIdentifier::UNIVERSAL_STRING_TAG);
	}
