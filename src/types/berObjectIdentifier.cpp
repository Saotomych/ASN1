...
quint32 CBerObjectIdentifier::deserialize(CBerByteArrayInputStream& iStream, CBerLength& length, quint32 codeLength)
{
...
quint32 CBerObjectIdentifier::decode(CBerByteArrayInputStream& iStream, bool explct)
{
